package com.rhalwi.wisata_lombok;
...
import com.rhalwi.wisata_lombok.model.wisata;
...
public class WisataActivity extends AppCompatActivity {
    ...
    final String[] tipeFavorite = {wisata.GILI,wisata.PANTAI,wisata.GUNUNG,wisata.TAMAN};
